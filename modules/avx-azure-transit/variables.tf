...
variable "vnet_name" {
  ...
  default = "az-transit-vnet"
}

variable "instance_size" {
  description = "Azure Instance size for the Aviatrix gateways"
  type        = string
  default     = "Standard_B2ms" # this is minimum size for Transit Firenet
}
...
variable "resource_tags" {
  description = "Tags for Aviatrix Transit Gateways"
  type        = list(string)
  default     = [
    "environment:dev",
 	  "solution:access",
 	  "department:gdt-connect"
  ]
}
